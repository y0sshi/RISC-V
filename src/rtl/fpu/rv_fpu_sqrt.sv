...
module rv_fpu_sqrt (
    ...
    always_comb begin
        casez (fra)
            ...
            23'b000001?????????????????: lz = 5'd5;
            23'b0000001????????????????: lz = 5'd6;
            23'b00000001???????????????: lz = 5'd7;
            23'b000000001??????????????: lz = 5'd8;
            23'b0000000001?????????????: lz = 5'd9;
            23'b00000000001????????????: lz = 5'd10;
            23'b000000000001???????????: lz = 5'd11;
            23'b0000000000001??????????: lz = 5'd12;
            23'b00000000000001?????????: lz = 5'd13;
            23'b000000000000001????????: lz = 5'd14;
            23'b0000000000000001???????: lz = 5'd15;
            23'b00000000000000001??????: lz = 5'd16;
            23'b000000000000000001?????: lz = 5'd17;
            23'b0000000000000000001????: lz = 5'd18;
            23'b00000000000000000001???: lz = 5'd19;
            23'b000000000000000000001??: lz = 5'd20;
            23'b0000000000000000000001?: lz = 5'd21;
            23'b00000000000000000000001: lz = 5'd22;
            default:                     lz = 5'd23;
        endcase
